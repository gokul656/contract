...
async function main() {
  ...
  const voteParamsLayout = {
    // index: 0,
    layout: struct([u8("index"), str("title")]),
  };
  ...
  voteParamsLayout.layout.encode({ index: 2, ...layoutFields }, dataBuffer);
  ...
  // Your Borsh-serialized binary data
//   const serializedData = new Uint8Array([
//     1, 4, 0, 0, 0, 121, 97, 122, 104, 3, 0, 0, 0, 98, 116, 99,
//   ]);

//   // Deserialize the binary data using the defined structure
//   const context = borsh.deserializeBorsh(new Context(), serializedData);

//   console.log(context, "contect......");
